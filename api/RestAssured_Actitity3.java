...
public class RestAssured_Actitity3 {
    ...
    public Object[][] petInfoProvider() {
        ...
        Object[][] testData = new Object[][] { 
            { 77232123, "Riley", "alive" }, 
            { 772332313, "Hansel", "alive" }
        };
        return testData;
    }
    ...
    public void addPets() {
        String reqBody = "{\"id\": 77232123, \"name\": \"Riley\", \"status\": \"alive\"}";
        Response response = given().spec(requestSpec) // Use requestSpec
                .body(reqBody) // Send request body
                .when().post(); // Send POST request
 
        reqBody = "{\"id\": 772332313, \"name\": \"Hansel\", \"status\": \"alive\"}";
